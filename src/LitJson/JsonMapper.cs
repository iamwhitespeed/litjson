...
namespace LitJson
{
    ...
    internal struct ArrayMetadata
    {
        ...
        public Type ElementType
        {
            get
            {
                return element_type ?? typeof(JsonData);
            }
    ...
    public class JsonMapper
    {
        ...
        private static void AddArrayMetadata(Type type)
        {
            ...
            ArrayMetadata data = new ArrayMetadata {IsArray = type.IsArray};
        ...
        static BindingFlags pflags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic;
        private static void AddObjectMetadata(Type type)
        {
            ...
            foreach (PropertyInfo p_info in type.GetProperties(pflags))
            {
                if (p_info.Name == "Item")
                {
                    ParameterInfo[] parameters = p_info.GetIndexParameters();
